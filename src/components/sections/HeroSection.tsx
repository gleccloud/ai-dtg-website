...
import { Play, ArrowRight, Star, Zap, Shield } from 'lucide-react';
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-slate-900 via-purple-900/20 to-slate-900">
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        ...
        >
          ...
          >
            Experience the next generation of intelligent digital twin technology. 
            Our platform combines cutting-edge AI with real-time data processing 
            to revolutionize how you monitor and optimize your operations.
          </motion.p>
          ...
          >
            ...
            <Button
              variant="outline"
              size="lg"
              className="border-white/20 text-white hover:bg-white/10 text-lg px-8 py-6 h-auto rounded-full group"
            >
