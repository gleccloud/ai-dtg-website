...
export class GLECScrollEffects {
     ...
     */
    calculateProgress(rect, threshold) {
     ...
     */
    applyAnimationProgress(config, progress) {
        const element = config.element;
        switch (config.effect) {
            case 'fade':
     ...
     */
    getSlideTransformWithProgress(direction, progress) {
...
export const addScrollEffect = (config) => glecScrollEffects.addEffect(config);
export const removeScrollEffect = (element) => glecScrollEffects.removeEffect(element);
export const smoothScrollTo = (element, duration) => glecScrollEffects.smoothScrollTo(element, duration);
export const getScrollProgress = () => glecScrollEffects.getScrollProgress();
export const isElementInViewport = (element) => glecScrollEffects.isElementInViewport(element);
