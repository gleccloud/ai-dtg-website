...
export class GLECAnimationSystem {
     ...
     */
    createStaggeredAnimation(elements, config, staggerDelay = 100) {
     ...
     */
    createTimelineAnimation(animations) {
        let currentDelay = 0;
     ...
     * Add hover animation
     */
    addHoverAnimation(element, hoverConfig, leaveConfig) {
...
export const createAnimation = (config) => glecAnimationSystem.createAnimation(config);
export const addScrollEffect = (config) => glecAnimationSystem.addScrollEffect(config);
export const createStaggeredAnimation = (elements, config, staggerDelay) => glecAnimationSystem.createStaggeredAnimation(elements, config, staggerDelay);
export const addHoverAnimation = (element, hoverConfig, leaveConfig) => glecAnimationSystem.addHoverAnimation(element, hoverConfig, leaveConfig);
